...
static BROTLI_NOINLINE BrotliResult SaveErrorCode(
  ...
  s->error_code = (int)e;
  //printf("from decode.c line 97 tent");
  switch (e) {
    case BROTLI_SUCCESS: return BROTLI_RESULT_SUCCESS;
    case BROTLI_NEEDS_MORE_INPUT:{/*printf("BROTLI_RESULT_NEEDS_MORE_INPUT");*/ return BROTLI_RESULT_NEEDS_MORE_INPUT;}
    case BROTLI_NEEDS_MORE_OUTPUT:{/*printf("BROTLI_RESULT_NEEDS_MORE_OUTPUT");*/ return BROTLI_RESULT_NEEDS_MORE_OUTPUT;}
    default:{/*printf("BROTLI_RESULT_ERROR");*/ return BROTLI_RESULT_ERROR;}
  }
}
